...
<footer class="text-center bg-dark" id="footers">
    <div class="container text-white py-4 py-lg-5">
        <ul class="list-inline">
            <li class="list-inline-item me-4"><a class="link-light" href="#">Plus d` information</a></li>
            <li class="list-inline-item me-4"><a class="link-light" href="#">Contacts</a></li>
            <li class="list-inline-item"><a class="link-light" href="#">Deconnect</a></li>
        </ul>
        <ul class="list-inline">
